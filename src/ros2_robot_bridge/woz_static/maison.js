var groupsList = [
	...
	["/static/images/face/theatre_emotions.png", "Le robot partage ses sentiments"],
	["/static/images/face/stars.png", "Renforcements positifs et encouragements"],
	["/static/images/face/theatre_a_definir_3.png","Le robot clos la scéance"],
	["/static/images/face/maison_debut_activite1.png", "Le robot ouvre la scéance"],
	["/static/images/face/presentation2.png", "Le robot se présente pour la première fois"],
	["/static/images/face/questionne.png", "Le robot et le jeu de mimes"],
	["/static/images/face/mimes2.png", "Réactions pour le jeu de mimes"],
	["/static/images/face/ghghgh.png", "Le robot et le travail manuel"],
	["/static/images/face/manuel.png", "Réactions pour pour les travaux manuels"],	
	["/static/images/face/wink.png", "Le robot et 1, 2, 3 soleil"],	
...
var textList = [
	...
	["", "Le robot partage ses sentiments"],
	["", "Renforcements positifs et encouragements"],
	["","Le robot clos la scéance"],
	["", "Le robot  ouvre la scéance"],
	["", "Le robot se présente pour la première fois"],
	["", "Le robot et le jeu de mimes"],
	["", "Réactions pour le jeu de mimes"],
	["", "Le robot et le travail manuel"],
	["", "Réactions pour pour les travaux manuels"],
	["", "Le robot et 1, 2, 3 soleil"],
...
var commandsList = [
	...
	// ["", "Le robot partage ses sentiments"],					
	["#5EEBF4", [	["Le robot surpris !", "surprise",0],
					["Le robot exprime la peur", "peur",0],
					["Le robot dégouté", "degout",0],
					["Le robot en colère !", "en_colere",0],
					["Le robot est heureux!", "bon_heur",0],
					["Le robot exprime sa tristesse", "_tristesse",0],
					["Le robot est fatigué", "_fatigue",0],
					["Le robot réfléchit !", "confusion",0] ]       ],
	// ["", "Renforcements positifs et encouragements"],				
